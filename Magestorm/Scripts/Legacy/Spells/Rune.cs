namespace Magestorm.Legacy.Spells
{
    ...
    public class Rune : Spell
    {
        ...
        public int aura_caster_effect;
        public int aura_target_effect;
        public SpellFriendlyType friendly;
        public int aura_pulse_timer;
        public int aura_health;
        public bool aura_stackable;
